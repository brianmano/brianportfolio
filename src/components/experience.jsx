...
const experiences = [
  {
    ...
    company: 'Oilstainlabs',
    duration: 'April 2025 – Present',
    location: 'Remote',
    image: oilstainlabsimg,
    description: [
      'Designed underbody aero for HF-11 Hypercar using Rhino and CFD (Ansys Fluent).',
      'Preprocessed geometry to balance detail and meshability.',
      'Validated CFD results (<2% error) with wind tunnel data.',
      'Generated technical reports on pressure, streamlines, and force data.',
    ],
    skills: ['Rhino', 'Ansys Fluent', 'CFD', 'Technical Reporting', 'Wind Tunnel Validation'],
  },
  {
    ...
    description: [
      ...
      'Designed aero components in Siemens NX, improved drag by 110%.',
      'Validated systems using CANape, Simulink, and AVL tools.',
    ...
    company: 'McMaster FSAE',
    duration: 'June 2025 – Present',
    location: 'Hamilton, ON',
    image: fsae,
    description: [
      'Designing aero components, including multi element rear wing, underbody and front wing in Siemens NX',
      'Ran and validating multi-condition CFD simulations using OpenFOAM.',
      'Developing genetic algorithms for optimal setups of aerodynamic components.',
    ],
  ...
  },
  {
    ...
    image: lyriq,
    description: [
      'Redesigned rear subfloor for inverter and modules using Siemens NX.',
